document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".o-t-navigation-list");
  const headerRef = document.querySelector(".o-t-header");
  const navigationRef = document.querySelector(".o-t-navigation");
  ...
  document.querySelectorAll(".o-t-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".o-t-toggle-button img");
